    ...
    <front>
        ...
        <abstract>
            <t>
                ...
                a JSON based format for defining the structure of JSON data. JSON Schema provides a contract for what
                JSON
        ...
        <section title="Conventions and Terminology">
            ...
            <t>
                ...
                <list style="hanging">
                    ...
                    <t hangText="instance">Equivalent to "JSON value" as defined in <xref target="RFC4627">RFC
                        4627</xref>.
                    </t>
...
Link: <http://example.com/my-hyper-schema>; rel="describedby"
            ...
            <section title="Self-Descriptive Schema">
                <t>
                    ...
                    used within a protocol with a media type specified SHOULD include a MIME parameter that refers to
                ...
                <t>
                    ...
                    <list style="hanging">
                        <t hangText="Simple Types">
                            A string indicating a primitive or simple type. The string MUST be one of the following
                            values:
                            ...
                            <list style="hanging">
                                ...
                                <t hangText="null">Instance MUST be the JSON literal "null". Note that without this
                                    type, null values are not allowed.
                                </t>
                        ...
                        <t hangText="Union Types">
                            ...
                            The instance value is valid if it is of the same type as one of the simple types, or valid
                            by one of the schemas, in the array.
                        </t>
                    </list>
                        ...
                        <![CDATA[
{
	"type": ["string", "number"]
            ...
            <section title="properties" anchor="properties">
                <t>
                    This attribute is an object with properties that specify the schemas for the properties of the
                    instance object.
                    In this attribute's object, each property value MUST be a schema.
                    When the instance value is an object, the value of the instance's properties MUST be valid according
                    to the schemas with the same property names specified in this attribute.
                    Objects are unordered, so therefore the order of the instance properties or attribute properties
                    MUST NOT determine validation success.
                </t>
            </section>
            ...
            <section title="patternProperties" anchor="patternProperties">
                <t>
                    ...
                    262/Perl 5 format, while the value is a schema.
                    If the pattern matches the name of a property on the instance object, the value of the instance's
                    property MUST be valid against the pattern name's schema value.
                </t>
            </section>
            ...
            <section title="additionalProperties" anchor="additionalProperties">
                ...
                </xref> or <xref target="patternProperties">"patternProperties"</xref> attributes (hereafter referred to
                    as "additional properties") is handled. If specified, the value MUST be a schema or a boolean.
                </t>
            ...
            <section title="items" anchor="items">
                <t>This attribute provides the allowed items in an array instance. If specified, this attribute MUST be
                ...
                <t>When this attribute value is an array of schemas and the instance value is an array, each position in
                    the instance array MUST be valid according to the schema in the corresponding position for this
                    array. This called tuple typing. When tuple typing is used, additional items are allowed,
                    disallowed, or constrained by the <xref target="additionalItems">"additionalItems"</xref> attribute
                    the same way as <xref target="additionalProperties">"additionalProperties"</xref> for objects is.
                </t>
            </section>
            ...
            <section title="additionalItems" anchor="additionalItems">
                <t>This attribute specifies how any item in the array instance that is not explicitly defined by <xref
                        target="items">"items"
                </xref> (hereafter referred to as "additional items") is handled. If specified, the value MUST be a
                    schema or a boolean.
                </t>
                <t>If a schema is provided:
                    <list>
                        <t>If the <xref target="items">"items"</xref> attribute is unspecified, then all items in the
                            array instance must be valid against this schema.
                        </t>
                        <t>If the <xref target="items">"items"</xref> attribute is a schema, then this attribute is
                            ignored.
                        </t>
                        <t>If the <xref target="items">"items"</xref> attribute is an array (during tuple typing), then
                            any additional items MUST be valid against this schema.
                        </t>
                    </list>
                </t>
            ...
            <section title="required" anchor="required">
                <t>This attribute is an array of strings that defines all the property names that must exist on the
                    object instance.
                </t>
            </section>

            <section title="dependencies" anchor="dependencies">
                <t>This attribute is an object that specifies the requirements of a property on an object instance. If
                    an object instance has a property with the same name as a property in this attribute's object, then
                    the instance must be valid against the attribute's property value (hereafter referred to as the
                    "dependency value").
                </t>
                <t>
                ...
                <t>
                    ...
                    <list>
                        ...
                        <t>are arrays, contains the same number of items, and each item in the array is equal to the
                            item at the corresponding index in the other array; or
                        </t>
            ...
            <section title="links" anchor="links">
                ...
                <section title="Link Description Object">
                    <t>
                        ...
                        (latest version) or
                        <eref target="http://json-schema.org/draft-04/links">http://json-schema.org/draft-04/links
                        </eref>
                        (draft-04 version).
                    </t>
...
[{
	...
	"upId": "parent"
                    ...
                    <section title="template">
                        <t>This property value is a string that defines the templating language used in the <xref
                                target="href">"href"
                        </xref> attribute. If no templating language is defined, then the default <xref target="href">
                            Link Description Object templating langauge
                        </xref> is used.
                        </t>
                    </section>
...
/Product/?name=Slinky
            ...
            <section title="fragmentResolution">
                ...
                <section title="json-pointer fragment resolution">
                    <t>The "json-pointer" fragment resolution protocol uses a <xref target="json-pointer">JSON Pointer
                    </xref> to resolve fragment identifiers in URIs within instance representations.
                    </t>
                </section>
            </section>
            ...
            <section title="readonly">
                <t>This attribute indicates that the instance value SHOULD NOT be changed. Attempts by a user agent to
                    modify the value of this property are expected to be rejected by a server.
                </t>
            </section>
